...
<?php include 'navbar.php'; ?>
    ...
    <button id="btnTambahfoto" class="bg-gray-500 text-white px-4 py-2 rounded mb-4">Unggah foto</button>
        ...
        <div class="max-w-md w-full bg-white rounded-lg shadow-md p-6">
            <table class="w-full">
                <tr>
                    ...
                    <td><input type="text" name="judulfoto" id="judulfoto" class="border p-2 rounded w-full focus:outline-none focus:ring focus:border-gray-300"></td>
                </tr>
                <tr>
                    <td class="py-2">Deskripsi</td>
                    <td><input type="text" name="deskripsifoto" id="deskripsifoto" class="border p-2 rounded w-full focus:outline-none focus:ring focus:border-gray-300"></td>
                </tr>
                <tr>
                    <td class="py-2">Lokasi File</td>
                    <td><input type="file" name="lokasifile" id="lokasifile" class="border p-2 rounded w-full focus:outline-none focus:ring focus:border-gray-300"></td>
                </tr>
                <tr>
                    <td class="py-2">Album</td>
                    <td>
                        <select name="albumid" id="albumid" class="border p-2 rounded w-full focus:outline-none focus:ring focus:border-gray-300">
                            <?php
                                include "koneksi.php";
                ...
                <tr>
                    <td></td>
                    <td><input type="submit" value="Tambah" class="bg-gray-500 text-white px-4 py-2 rounded cursor-pointer hover:bg-gray-600"></td>
                </tr>
            </table>
        </div>
    </form>
        ...
        <div class="bg-white border rounded-md overflow-hidden shadow-md transform transition-transform ease-in-out hover:scale-105 relative">
            ...
            <div class="p-4">
                ...
                <a href="hapus_foto.php?fotoid=<?= $data['fotoid'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus foto ini?');" class="text-red-500 hover:underline"><i class="fa-solid fa-trash"></i></a>
                    <a href="edit_foto.php?fotoid=<?=$data['fotoid']?>" class="text-gray-500 hover:underline"><i class="fa-solid fa-pen-to-square"></i></a>
                </div>
            </div>
        </div>
    <?php
