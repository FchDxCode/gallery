...
<body class="font-sans bg-gray-300">
    ...
    <div class="bg-gray-300 p-4">
        <h1 class="text-3xl text-center text-gray-800">Welcome To ThinkGalerry</h1>
        <?php if (isset($_SESSION['userid'])) : ?>
            <p class="text-center mt-4">Welcome <b><?= $_SESSION['namalengkap'] ?></b></p>
        <?php endif; ?>
    </div>
    ...
    <div class="container mx-auto mt-4 p-4">
        <form action="" method="GET">
            <div class="flex items-center justify-start">
                <input type="text" name="search" placeholder="Search..." class="border border-gray-300 w-[25rem] px-4 py-2 rounded-md outline-none">
                <button type="submit" class="ml-2 bg-red-500 text-black px-4 py-2 rounded-md hover:bg-red-600"><i class="fa-solid fa-magnifying-glass"></i></button>
            </div>
        </form>
    </div>
    ...
    <div class="container mx-auto mt-8 p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        ?>
            <div class="relative bg-[#2A3132] border rounded-md overflow-hidden shadow-md transform transition-transform ease-in-out hover:scale-105">
                <!-- Container for image -->
                ...
                <div class="like-button">
                    ...
                    if (isset($_SESSION['userid'])) {
                        ...
                        $heart_icon_class = $liked ? "fa-brands fa-gratipay text-pink-500" : "fa-brands fa-gratipay text-slate-200";
                    ?>
                ...
                <div class="p-4">
                    ...
                    <p class="text-sm text-white"><?= $data['deskripsifoto'] ?></p>
                    <div class="flex justify-between items-center mt-2 text-red-500">
    ...
    <div class="container mx-auto mt-8 p-4">
        <ul class="flex justify-center space-x-4">
            ...
            for ($page = 1; $page <= $total_pages; $page++) {
                echo '<li><a href="?search=' . $search . '&page=' . $page . '" class="px-4 py-2 bg-red-400 text-white rounded-md hover:bg-red-500">' . $page . '</a></li>';
            }
            ?>
        </ul>
    </div>
    <footer class="bg-[#2A3132] text-white p-4 text-center">
        <p>&copy; 2024 ThinkGalerry. All rights reserved.</p>
    </footer>
