...
<?php include 'adminnavbar.php'; ?>
    <div class="bg-gray-300 p-4">
        ...
        if (!isset($_SESSION['userid'])) {
            ...
            ?>
            <h1 class="text-3xl text-center text-gray-800">Welcome To ThinkGallery</h1>
            <p class="text-center mt-4">Welcome <b>
        ...
        <form action="" method="GET">
            <div class="flex items-center justify-start">
                <input type="text" name="search" placeholder="Search..."
                    class="border border-gray-300 px-4 py-2 rounded-md w-[25rem] outline-none">
                <button type="submit" class="ml-2 bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600"><i
    ...
    <div class="container mx-auto mt-8 p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        while ($data = mysqli_fetch_array($sql)) {
            ?>
            <div
                class="relative bg-[#2A3132] border rounded-md overflow-hidden shadow-md transform transition-transform ease-in-out hover:scale-105">
                <!-- Container for image -->
    ...
    <div class="container mx-auto mt-8 p-4">
        <ul class="flex justify-center space-x-4">
            ...
            for ($page = 1; $page <= $total_pages; $page++) {
                echo '<li><a href="?search=' . $search . '&page=' . $page . '" class="px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600">' . $page . '</a></li>';
            }
            ?>
        </ul>
    </div>
    ...
    <footer class="bg-[#2A3132] text-white p-4 text-center">
        <p>&copy; 2024 ThinkGallery. All rights reserved.</p>
    </footer>
