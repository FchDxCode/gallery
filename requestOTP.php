...
<body>
    <div class="flex items-center justify-center min-h-screen bg-gray-300">
        <div class="w-full max-w-md">
            ...
            <form action="" method="post" class="bg-[#2A3132] shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div class="mb-4">
                    <label for="email" class="block text-gray-700 font-bold mb-2 text-white">Email</label>
                ...
                <div class="flex items-center justify-between mb-4">
                    <button type="submit"
                        class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Submit</button>
