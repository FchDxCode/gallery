...
<body class="font-sans bg-gray-300">
    <div class="bg-gray-300 p-4">
        ...
        <?php if (isset($_SESSION['namalengkap'])): ?>
            <h1 class="text-3xl text-center text-gray-800">Detail Pages</h1>
            <p class="text-center mt-2">Welcome <b>
    ...
    <div class="container mx-auto mt-15 p-4 grid grid-cols-1 lg:grid-cols-2 gap-4 "> <!-- Tambahkan padding disini -->
        <form action="" method="post" class="mb-8">
            ...
            while ($data = mysqli_fetch_array($sql)) {
                ...
                <div class="bg-[#2A3132] shadow-md rounded-lg p-4 pb-4"> <!-- Tambahkan kelas pb-4 disini -->
                    ...
                    <div class="text-left">
                        ...
                        <p class="mb-4 text-slate-100 text-md">
                            <?= $data['deskripsifoto'] ?>
                        </p>
                    </div>
                    <?php if (isset($_SESSION['userid'])): ?>
                        <div class="flex items-center mb-6">
                            <input type="text" name="isikomentar" placeholder="Tambah komentar"
                                class="border-2 border-gray-300 p-3 rounded-lg w-full outline-none">
                            <button type="submit"
                                class="bg-red-500 text-white px-4 py-3 rounded-lg ml-4 hover:bg-red-600 focus:outline-none focus:bg-red-600"><i
        ...
        <div class="bg-[#2A3132] shadow-md rounded-lg p-4 pb-4"> 
            <h2 class="text-xl text-white font-semibold mb-4">Comment</h2>
